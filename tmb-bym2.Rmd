...
If the random effect $x_i$ is directly parameterised as in the `R-INLA` implementation, for example $\mu_i = \beta_0 + x_i,$ the starting value for $\mu_i$ is unchanged by the updated hyperparamters.
